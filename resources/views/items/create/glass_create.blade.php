...
@section('content')
<div class="container">
    <h2>Creazione Nuovo Tipo di Bicchiere</h2>
    <form method="POST" action="{{ route('glasses.store') }}" enctype="multipart/form-data" id="form">
        @csrf
        ...
        <button type="submit" class="btn btn-primary" id="submitButton" >Crea Bicchiere</button>
    </form>
</div>
<script>
